...
class PhonemeTutorAllTest extends React.Component {
  constructor() {
    super();
  ...
  componentDidMount = async () => {
    const doc = await axios.get("/api/phoneme/test");
          ...
          {assignments.map((assign, index) => {
            return (
              <TrainCard
                ...
                handleClick={() =>
                  (window.location = "/tutor/phoneme/test/" + assign._id)
                }
              />
            );
          })}
...
export default PhonemeTutorAllTest;
